...
<script type="text/javascript">
	...
	/* blank Check  */
	 function blankCheck() {
		...
		f.action = "<%=cp %>/register/register_ok.jsp";
		f.submit();
	}
	...
	function chked(){
		...
		if(f.chckbx[0].checked == true){
	 	
				f.email.readOnly = true;
				f.email2.readOnly = true;
		}else if(f.chckbx[0].checked == false){
			f.email.readOnly = false;
			f.email2.readOnly = false;
		}
		
		if(f.chckbx[1].checked == true){
			f.tel.readOnly = true;
			f.tel1.readOnly = true;
			document.myForm.tel2.readOnly = true;
		}else if(f.chckbx[1].checked == false){
			f.tel.readOnly = false;
			f.tel1.readOnly = false;
				...
				<td style="border-bottom: 1px solid #EAEAEA;" align="center">
					...
					<table class="bg_color" border="0" width="680pt"
						...
						<tr>
							<td>
							&nbsp;&nbsp;
							<input type="text" name="email1" style="width: 80pt;" /> 
							@ <input type="text" name="email2"
								readonly="readonly" /> 
								<select name="sel2" onchange="emailCheck();">
									<option value="">선택하세요</option>
								...
								<input name="chckbx" type="checkbox" value="" onclick="checkBox();">
								등록 안함
						...
						<tr>
							<td>&nbsp;&nbsp;
							<select name="tel1" style="width: 80pt;">
							...
							- <input type="text" name="tel3"
								onkeypress="onlyNum();" style="width: 80pt;" /> 
								<input name="telCB" type="checkbox" onclick="checkBox();;" >등록 안함
							</td>
						</tr>
			...
			<tr align="center">
				<td
					...
					height="80pt" colspan="2">
						...
						<input type="reset" class="btn" value="다시입력" onclick="document.myForm.userName.focus();"/>
