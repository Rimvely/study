...
<%
	...
	DBconn.close();
 	...
 	if(dto==null){
		response.sendRedirect("regiserList.jsp");
	}
...
/*  		if (f.userName.value == "") {
		...
		f.action = "<%=cp %>/register/register_update_ok.jsp";
		f.submit();
	}
...
<form action="" name="myForm" method="post">
		...
		<table class="setWidth2" border="0" cellspacing="0">
			...
			<tr>
				...
				<input name="userNick" value="<%=dto.getUserNick() %>" type="text"></td>
			</tr>
			...
			<tr>
				...
				<td style="border-bottom: 1px solid #EAEAEA;">
					<input name="userPw1" value="<%=dto.getUserPw1() %>" type="password"> <font
			...
			<tr>
				...
				<td style="border-bottom: 1px solid #EAEAEA;" align="center">
					...
					<table class="bg_color" border="0" width="680pt"
						...
						<tr>
							<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							<input type="text" name="answer1" value="<%=dto.getAnswer1() %>" readonly="readonly"
								style="padding: 1px; width: 455pt;" />
							</td>
						</tr>
	
						<tr>
							<td>&nbsp;&nbsp;답변 <input type="text" value="<%=dto.getAnswer2() %>" name="answer2"
								style="width: 457pt;">
							</td>
						</tr>
						...
						<tr>
							<td>
							&nbsp;&nbsp;<input type="text" value="<%=dto.getEmail1() %>" name="email1"
								style="width: 80pt;" /> @ <input type="text" value="<%=dto.getEmail2() %>" name="email2"
						...
						<tr>
							<td>&nbsp;&nbsp;<select name="tel1" value="<%=dto.getTel1() %>" style="width: 80pt;">
									<option value="">선택</option>
									<option value="010">010</option>
									<option value="011">011</option>
									<option value="070">070</option>
							</select> <input type="text" value="<%=dto.getTel2() %>" name="tel2" onkeypress="onlyNum();"
								style="width: 80pt;" /> - <input type="text" value="<%=dto.getTel3() %>" name="tel3"
			...
			<tr align="center">
				<td
					...
					<input type="hidden" name="userId" value="<%=dto.getUserId() %>"/>
						...
						<input type="button" class="btn" value="입력취소" onclick="javascript:location.href='<%=cp%>/register/registerList.jsp';"/>
				</td>
